                    ...
                    if (checkAdminDataName(aname_TF.getText().trim())) {
                        ...
                        if (checkAdminDataSurname(asurname_TF.getText().trim())) {
                            ...
                            if (checkAdminDataPassword(String.valueOf(apassword_TF.getPassword()), aname_TF.getText(), asurname_TF.getText())) {
                                ...
                                System.out.println(String.valueOf(apassword_TF.getPassword()).trim()+"a");
                                System.out.println(aname_TF.getText().trim()+"b");
                                System.out.println(asurname_TF.getText().trim()+"c");
                                System.out.println(checkAdminDataPassword(String.valueOf(apassword_TF.getPassword()).trim(), aname_TF.getText().trim(), asurname_TF.getText().trim())+"d");
