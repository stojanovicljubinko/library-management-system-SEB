...
class GraphicInterfaceUser {
    ...
    protected static void setSelectedColour(JPanel sjbt) {
        sjbt.setBackground(Color.decode("#638FB4"));
    }

    protected static void setUnselectedColour(JPanel ujbt) {
    ...
    protected static void setSelectedColour(JLabel sjbt) {
        sjbt.setForeground(Color.decode("#FFFFFF"));
    }

    protected static void setUnselectedColour(JLabel ujbt) {
